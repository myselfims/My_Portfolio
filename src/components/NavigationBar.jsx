  ...
  return (
    ...
    >
      ...
      <div className="flex items-center">
        ...
        <a target="_blank" className="p-2 rounded-xl bg-sky-500 text-white ml-4 hover:opacity-70 text-nowrap" href="https://drive.google.com/file/d/1moca6KHuqO1hkvuGbJjN8I450Bz-lCeW/view?usp=sharing"><FaFilePdf className="inline w-5 h-5 mr-2"/>Resume</a>
      </div>
      <GiHamburgerMenu
